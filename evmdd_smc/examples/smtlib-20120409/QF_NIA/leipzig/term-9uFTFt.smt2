...
(assert (= n174 (+ n30 n172)))
(declare-fun n175 () Int)
(assert (= n175 (+ n31 n173)))
...
(assert (= n214 (+ n24 n212)))
(declare-fun n215 () Int)
(assert (= n215 (+ n25 n213)))
...
(assert (= n294 (+ n18 n292)))
(declare-fun n295 () Int)
(assert (= n295 (+ n19 n293)))
...
(assert (= n314 (+ n36 n312)))
(declare-fun n315 () Int)
(assert (= n315 (+ n37 n313)))
...
(assert (= n354 (+ n12 n352)))
(declare-fun n355 () Int)
(assert (= n355 (+ n13 n353)))
...
(assert (= n374 (+ n74 n372)))
(declare-fun n375 () Int)
(assert (= n375 (+ n75 n373)))
...
(assert (>= n366 n386))
(assert (>= n367 n387))
(assert (or (> n94 n114) (> n134 n154) (> n174 n194) (> n214 n234) (> n254 n274) (> n294 n314) (> n334 n54) (> n354 n374)))
(check-sat)
(exit)
