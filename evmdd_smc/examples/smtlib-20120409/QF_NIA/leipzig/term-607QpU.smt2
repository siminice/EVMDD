...
(assert (= n106 (+ n102 n103)))
(declare-fun n107 () Int)
(assert (= n107 (+ n104 n105)))
...
(assert (= n318 (* n54 n134)))
(declare-fun n319 () Int)
(assert (= n319 (* n55 n135)))
(declare-fun n320 () Int)
(assert (= n320 (* n56 n134)))
(declare-fun n321 () Int)
(assert (= n321 (* n57 n135)))
...
(assert (= n326 (* n54 n144)))
(declare-fun n327 () Int)
(assert (= n327 (* n55 n146)))
(declare-fun n328 () Int)
(assert (= n328 (* n54 n145)))
(declare-fun n329 () Int)
(assert (= n329 (* n55 n147)))
(declare-fun n330 () Int)
(assert (= n330 (* n56 n144)))
(declare-fun n331 () Int)
(assert (= n331 (* n57 n146)))
(declare-fun n332 () Int)
(assert (= n332 (* n56 n145)))
(declare-fun n333 () Int)
(assert (= n333 (* n57 n147)))
...
(assert (= n344 (+ n12 n342)))
(declare-fun n345 () Int)
(assert (= n345 (+ n13 n343)))
...
(assert (= n364 (+ n44 n362)))
(declare-fun n365 () Int)
(assert (= n365 (+ n45 n363)))
...
(assert (>= n356 n376))
(assert (>= n357 n377))
(assert (or (> n151 n191) (> n201 n151) (> n181 n211) (> n181 n151) (> n221 n231)))
(check-sat)
(exit)
